...
public abstract class Creature {
    ...
    protected final int[] catdirRow = {-2,0,2,0};
    protected final int[] catdirCol = {0, 2, 0, -2};
    protected final int[] zombiedirRow = {-3,0,3,0};
    protected final int[] zombiedirCol = {0, 3, 0, -3};
    protected final int[] sdirRow = {-4,0,4,0};
    protected final int[] sdirCol = {0, 4, 0, -4};
    ...
    //set gridpoint
    public GridPoint setGridPoint(int r, int c){
        this.point = new GridPoint(r, c);
        return this.point;
    }

    //set direction
    public int setDir(int dire){
        this.dir = dire;
        return this.dir;
    }
    ...
    public int dist(Creature cr){
        return point.dist(cr.getGridPoint());
    }
